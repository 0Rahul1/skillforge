...
const rawQuestions = [
  ...
  {
    "question": "Explain the primary search strategy used in the A* algorithm? (Practice)",
    "options": [
      "Best-First Search guided by f(n) = g(n) + h(n)",
      "Depth-First Search",
      "Breadth-First Search",
  ...
  {
    "question": "Concept check: What is the primary search strategy used in the A* algorithm?",
    "options": [
      "Best-First Search guided by f(n) = g(n) + h(n)",
      "Depth-First Search",
      "Breadth-First Search",
  ...
  {
    "question": "Which framework is historically used for defining agent actions and plans in AI? (Practice)",
    "options": [
      "STRIPS",
      "REST",
      "TensorFlow",
  ...
  {
    "question": "Concept check: Which framework is historically used for defining agent actions and plans in AI?",
    "options": [
      "STRIPS",
      "REST",
      "TensorFlow",
  ...
  {
    "question": "In minimax search trees, what does alpha-beta pruning do? (Practice)",
    "options": [
      "Reduces the number of nodes evaluated by minimax",
      "Speeds up sorting of nodes",
      "Performs random sampling of nodes",
  ...
  {
    "question": "Concept check: In minimax search trees, what does alpha-beta pruning do?",
    "options": [
      "Reduces the number of nodes evaluated by minimax",
      "Speeds up sorting of nodes",
      "Performs random sampling of nodes",
  ...
  {
    "question": "Explain the goal of a heuristic function in search? (Practice)",
    "options": [
      "To estimate cost from current state to goal",
      "To calculate exact cost of path",
      "To randomize path selection",
  ...
  {
    "question": "Concept check: What is the goal of a heuristic function in search?",
    "options": [
      "To estimate cost from current state to goal",
      "To calculate exact cost of path",
      "To randomize path selection",
  ...
  {
    "question": "Which AI representation format uses semantic nets of nodes and edges? (Practice)",
    "options": [
      "Knowledge Graphs",
      "CSV tables",
      "Binary trees",
  ...
  {
    "question": "Concept check: Which AI representation format uses semantic nets of nodes and edges?",
    "options": [
      "Knowledge Graphs",
      "CSV tables",
      "Binary trees",
  ...
  {
    "question": "What does the bias-variance tradeoff represent in machine learning? (Practice)",
    "options": [
      "The balance between underfitting and overfitting",
      "The size of the dataset vs training speed",
      "The loss function choice",
  ...
  {
    "question": "Concept check: What does the bias-variance tradeoff represent in machine learning?",
    "options": [
      "The balance between underfitting and overfitting",
      "The size of the dataset vs training speed",
      "The loss function choice",
  ...
  {
    "question": "Which regularization method performs L1 regularization, potentially setting weights to zero? (Practice)",
    "options": [
      "Lasso Regression",
      "Ridge Regression",
      "Elastic Net",
  ...
  {
    "question": "Concept check: Which regularization method performs L1 regularization, potentially setting weights to zero?",
    "options": [
      "Lasso Regression",
      "Ridge Regression",
      "Elastic Net",
  ...
  {
    "question": "Explain the purpose of K-Fold Cross-Validation? (Practice)",
    "options": [
      "To get a robust estimate of model generalization",
      "To speed up model training",
      "To perform feature scaling",
  ...
  {
    "question": "Concept check: What is the purpose of K-Fold Cross-Validation?",
    "options": [
      "To get a robust estimate of model generalization",
      "To speed up model training",
      "To perform feature scaling",
  ...
  {
    "question": "Which algorithm finds the hyperplane maximizing the margin between classes? (Practice)",
    "options": [
      "Support Vector Machines",
      "Logistic Regression",
      "Naive Bayes",
  ...
  {
    "question": "Concept check: Which algorithm finds the hyperplane maximizing the margin between classes?",
    "options": [
      "Support Vector Machines",
      "Logistic Regression",
      "Naive Bayes",
  ...
  {
    "question": "Explain Principal Component Analysis (PCA) primarily used for? (Practice)",
    "options": [
      "Dimensionality reduction",
      "Classification",
      "Regression",
  ...
  {
    "question": "Concept check: What is Principal Component Analysis (PCA) primarily used for?",
    "options": [
      "Dimensionality reduction",
      "Classification",
      "Regression",
  ...
  {
    "question": "Explain the primary role of backpropagation in training neural networks? (Practice)",
    "options": [
      "To calculate gradients of loss function with respect to weights",
      "To initialize weights randomly",
      "To scale dataset inputs",
  ...
  {
    "question": "Concept check: What is the primary role of backpropagation in training neural networks?",
    "options": [
      "To calculate gradients of loss function with respect to weights",
      "To initialize weights randomly",
      "To scale dataset inputs",
  ...
  {
    "question": "Which activation function is defined as f(x) = max(0, x)? (Practice)",
    "options": [
      "ReLU",
      "Sigmoid",
      "Tanh",
  ...
  {
    "question": "Concept check: Which activation function is defined as f(x) = max(0, x)?",
    "options": [
      "ReLU",
      "Sigmoid",
      "Tanh",
  ...
  {
    "question": "What does Batch Normalization normalize in a neural network layer? (Practice)",
    "options": [
      "The activations of the previous layer across a mini-batch",
      "The training dataset targets",
      "The learning rate of the optimizer",
  ...
  {
    "question": "Concept check: What does Batch Normalization normalize in a neural network layer?",
    "options": [
      "The activations of the previous layer across a mini-batch",
      "The training dataset targets",
      "The learning rate of the optimizer",
  ...
  {
    "question": "Explain the main mechanism that allows Transformers to process sequences in parallel? (Practice)",
    "options": [
      "Self-Attention mechanism",
      "Recurrent LSTM cells",
      "Convolutional filters",
  ...
  {
    "question": "Concept check: What is the main mechanism that allows Transformers to process sequences in parallel?",
    "options": [
      "Self-Attention mechanism",
      "Recurrent LSTM cells",
      "Convolutional filters",
  ...
  {
    "question": "What are the residual connections (skip connections) in ResNet used for? (Practice)",
    "options": [
      "To mitigate the vanishing gradient problem in deep networks",
      "To speed up data loading",
      "To perform dimensional scaling",
  ...
  {
    "question": "Concept check: What are the residual connections (skip connections) in ResNet used for?",
    "options": [
      "To mitigate the vanishing gradient problem in deep networks",
      "To speed up data loading",
      "To perform dimensional scaling",
  ...
  {
    "question": "Which Pandas method is used to group data sharing common column values? (Practice)",
    "options": [
      "groupby()",
      "merge()",
      "concat()",
  ...
  {
    "question": "Concept check: Which Pandas method is used to group data sharing common column values?",
    "options": [
      "groupby()",
      "merge()",
      "concat()",
  ...
  {
    "question": "What does correlation measure in statistics? (Practice)",
    "options": [
      "The strength and direction of linear relationship between two variables",
      "The causal effect of one variable on another",
      "The variance of a single variable",
  ...
  {
    "question": "Concept check: What does correlation measure in statistics?",
    "options": [
      "The strength and direction of linear relationship between two variables",
      "The causal effect of one variable on another",
      "The variance of a single variable",
  ...
  {
    "question": "Explain EDA (Exploratory Data Analysis) used for? (Practice)",
    "options": [
      "To summarize data main characteristics and discover patterns visually",
      "To deploy machine learning models",
      "To format databases for production",
  ...
  {
    "question": "Concept check: What is EDA (Exploratory Data Analysis) used for?",
    "options": [
      "To summarize data main characteristics and discover patterns visually",
      "To deploy machine learning models",
      "To format databases for production",
  ...
  {
    "question": "Explain the risk of using data from the validation/test set in feature engineering? (Practice)",
    "options": [
      "Data leakage",
      "Overfitting on training set",
      "Vanishing gradients",
  ...
  {
    "question": "Concept check: What is the risk of using data from the validation/test set in feature engineering?",
    "options": [
      "Data leakage",
      "Overfitting on training set",
      "Vanishing gradients",
  ...
  {
    "question": "Which imputation method replaces missing values with the most frequent value? (Practice)",
    "options": [
      "Mode Imputation",
      "Mean Imputation",
      "Median Imputation",
  ...
  {
    "question": "Concept check: Which imputation method replaces missing values with the most frequent value?",
    "options": [
      "Mode Imputation",
      "Mean Imputation",
      "Median Imputation",
  ...
  {
    "question": "What mathematical operation is the core building block of CNNs? (Practice)",
    "options": [
      "Convolution",
      "Matrix Inversion",
      "Eigenvalue Decomposition",
  ...
  {
    "question": "Concept check: What mathematical operation is the core building block of CNNs?",
    "options": [
      "Convolution",
      "Matrix Inversion",
      "Eigenvalue Decomposition",
  ...
  {
    "question": "Which architecture is famous for real-time, single-shot object detection? (Practice)",
    "options": [
      "YOLO",
      "R-CNN",
      "AlexNet",
  ...
  {
    "question": "Concept check: Which architecture is famous for real-time, single-shot object detection?",
    "options": [
      "YOLO",
      "R-CNN",
      "AlexNet",
  ...
  {
    "question": "What does IoU (Intersection over Union) measure in object detection? (Practice)",
    "options": [
      "Overlap between predicted bounding box and ground truth",
      "The number of object classes",
      "The speed of frame processing",
  ...
  {
    "question": "Concept check: What does IoU (Intersection over Union) measure in object detection?",
    "options": [
      "Overlap between predicted bounding box and ground truth",
      "The number of object classes",
      "The speed of frame processing",
  ...
  {
    "question": "Which library is the industry standard for image processing in Python? (Practice)",
    "options": [
      "OpenCV",
      "SciPy",
      "Matplotlib",
  ...
  {
    "question": "Concept check: Which library is the industry standard for image processing in Python?",
    "options": [
      "OpenCV",
      "SciPy",
      "Matplotlib",
  ...
  {
    "question": "What does a pooling layer do in a CNN? (Practice)",
    "options": [
      "Reduces spatial dimensions of feature maps",
      "Increases the number of channels",
      "Calculates class probabilities",
  ...
  {
    "question": "Concept check: What does a pooling layer do in a CNN?",
    "options": [
      "Reduces spatial dimensions of feature maps",
      "Increases the number of channels",
      "Calculates class probabilities",
  ...
  {
    "question": "Explain tokenization in NLP? (Practice)",
    "options": [
      "Splitting text into words, subwords, or characters",
      "Converting text to dense vectors",
      "Extracting parts of speech",
  ...
  {
    "question": "Concept check: What is tokenization in NLP?",
    "options": [
      "Splitting text into words, subwords, or characters",
      "Converting text to dense vectors",
      "Extracting parts of speech",
  ...
  {
    "question": "Which model first introduced bidirectional context learning using masked language modeling? (Practice)",
    "options": [
      "BERT",
      "GPT",
      "Word2Vec",
  ...
  {
    "question": "Concept check: Which model first introduced bidirectional context learning using masked language modeling?",
    "options": [
      "BERT",
      "GPT",
      "Word2Vec",
  ...
  {
    "question": "What does TF-IDF stand for? (Practice)",
    "options": [
      "Term Frequency - Inverse Document Frequency",
      "Token Flow - Input Data Format",
      "Text Filtering - Intelligent Document Find",
  ...
  {
    "question": "Concept check: What does TF-IDF stand for?",
    "options": [
      "Term Frequency - Inverse Document Frequency",
      "Token Flow - Input Data Format",
      "Text Filtering - Intelligent Document Find",
  ...
  {
    "question": "Which vector representation captures semantic relationships between words? (Practice)",
    "options": [
      "Word Embeddings",
      "One-Hot Encoding",
      "Bag of Words",
  ...
  {
    "question": "Concept check: Which vector representation captures semantic relationships between words?",
    "options": [
      "Word Embeddings",
      "One-Hot Encoding",
      "Bag of Words",
  ...
  {
    "question": "What metric is commonly used to evaluate machine translation output quality? (Practice)",
    "options": [
      "BLEU Score",
      "F1 Score",
      "MSE",
  ...
  {
    "question": "Concept check: What metric is commonly used to evaluate machine translation output quality?",
    "options": [
      "BLEU Score",
      "F1 Score",
      "MSE",
  ...
  {
    "question": "What are the two networks in a Generative Adversarial Network (GAN)? (Practice)",
    "options": [
      "Generator and Discriminator",
      "Encoder and Decoder",
      "Actor and Critic",
  ...
  {
    "question": "Concept check: What are the two networks in a Generative Adversarial Network (GAN)?",
    "options": [
      "Generator and Discriminator",
      "Encoder and Decoder",
      "Actor and Critic",
  ...
  {
    "question": "Which technique is used to fine-tune LLMs with low-rank adapters? (Practice)",
    "options": [
      "LoRA",
      "RLHF",
      "Quantization",
  ...
  {
    "question": "Concept check: Which technique is used to fine-tune LLMs with low-rank adapters?",
    "options": [
      "LoRA",
      "RLHF",
      "Quantization",
  ...
  {
    "question": "What does temperature control in generative language models? (Practice)",
    "options": [
      "The randomness of token selection",
      "The model context window size",
      "The learning rate during fine-tuning",
  ...
  {
    "question": "Concept check: What does temperature control in generative language models?",
    "options": [
      "The randomness of token selection",
      "The model context window size",
      "The learning rate during fine-tuning",
  ...
  {
    "question": "Explain the primary role of diffusion models in image generation? (Practice)",
    "options": [
      "Denoising random noise step-by-step to construct images",
      "Classifying images into categories",
      "Converting images to black-and-white",
  ...
  {
    "question": "Concept check: What is the primary role of diffusion models in image generation?",
    "options": [
      "Denoising random noise step-by-step to construct images",
      "Classifying images into categories",
      "Converting images to black-and-white",
  ...
  {
    "question": "What does RAG stand for in the context of LLM applications? (Practice)",
    "options": [
      "Retrieval-Augmented Generation",
      "Random Access Graph",
      "Recursive Agent Grouping",
  ...
  {
    "question": "Concept check: What does RAG stand for in the context of LLM applications?",
    "options": [
      "Retrieval-Augmented Generation",
      "Random Access Graph",
      "Recursive Agent Grouping",
  ...
  {
    "question": "Explain Few-Shot prompting? (Practice)",
    "options": [
      "Providing a few examples of task outputs in the prompt",
      "Training the LLM on a small dataset",
      "Running the prompt in multiple short turns",
  ...
  {
    "question": "Concept check: What is Few-Shot prompting?",
    "options": [
      "Providing a few examples of task outputs in the prompt",
      "Training the LLM on a small dataset",
      "Running the prompt in multiple short turns",
  ...
  {
    "question": "Which prompting technique directs the model to explain its reasoning step-by-step? (Practice)",
    "options": [
      "Chain of Thought prompting",
      "Zero-Shot prompting",
      "System prompting",
  ...
  {
    "question": "Concept check: Which prompting technique directs the model to explain its reasoning step-by-step?",
    "options": [
      "Chain of Thought prompting",
      "Zero-Shot prompting",
      "System prompting",
  ...
  {
    "question": "Explain prompt injection? (Practice)",
    "options": [
      "Inserting malicious instructions to bypass LLM safety guardrails",
      "Injecting database vectors into prompt templates",
      "Automating prompt creation with scripts",
  ...
  {
    "question": "Concept check: What is prompt injection?",
    "options": [
      "Inserting malicious instructions to bypass LLM safety guardrails",
      "Injecting database vectors into prompt templates",
      "Automating prompt creation with scripts",
  ...
  {
    "question": "What does a 'system prompt' do in an LLM chat setup? (Practice)",
    "options": [
      "Defines the model role, behavior, and constraints globally",
      "Saves chat history to the server database",
      "Translates user inputs to English",
  ...
  {
    "question": "Concept check: What does a 'system prompt' do in an LLM chat setup?",
    "options": [
      "Defines the model role, behavior, and constraints globally",
      "Saves chat history to the server database",
      "Translates user inputs to English",
  ...
  {
    "question": "Explain the benefit of defining output schemas (like JSON) in prompts? (Practice)",
    "options": [
      "Ensures structured, parseable responses for applications",
      "Speeds up token generation times",
      "Reduces model API cost",
  ...
  {
    "question": "Concept check: What is the benefit of defining output schemas (like JSON) in prompts?",
    "options": [
      "Ensures structured, parseable responses for applications",
      "Speeds up token generation times",
      "Reduces model API cost",
  ...
  {
    "question": "What does the ReAct framework in AI agents stand for? (Practice)",
    "options": [
      "Reasoning and Acting",
      "Re-evaluating Action trees",
      "Recurrent Agent control",
  ...
  {
    "question": "Concept check: What does the ReAct framework in AI agents stand for?",
    "options": [
      "Reasoning and Acting",
      "Re-evaluating Action trees",
      "Recurrent Agent control",
  ...
  {
    "question": "How do autonomous AI agents interact with external systems? (Practice)",
    "options": [
      "Through Tool Calling (APIs, execution environments)",
      "By retraining their base models",
      "By accessing database files directly",
  ...
  {
    "question": "Concept check: How do autonomous AI agents interact with external systems?",
    "options": [
      "Through Tool Calling (APIs, execution environments)",
      "By retraining their base models",
      "By accessing database files directly",
  ...
  {
    "question": "Which library is widely used to coordinate LLMs, tools, and agents in Python? (Practice)",
    "options": [
      "LangChain",
      "Django",
      "NumPy",
  ...
  {
    "question": "Concept check: Which library is widely used to coordinate LLMs, tools, and agents in Python?",
    "options": [
      "LangChain",
      "Django",
      "NumPy",
  ...
  {
    "question": "What kind of memory allows agents to recall instructions and past interactions in the current session? (Practice)",
    "options": [
      "Short-term / Conversational Memory",
      "Vector Database Storage",
      "Base model parameters",
  ...
  {
    "question": "Concept check: What kind of memory allows agents to recall instructions and past interactions in the current session?",
    "options": [
      "Short-term / Conversational Memory",
      "Vector Database Storage",
      "Base model parameters",
  ...
  {
    "question": "Explain a multi-agent system? (Practice)",
    "options": [
      "A setup where multiple specialized agents collaborate to solve tasks",
      "A server running multiple copies of an LLM",
      "An agent using multiple API keys",
  ...
  {
    "question": "Concept check: What is a multi-agent system?",
    "options": [
      "A setup where multiple specialized agents collaborate to solve tasks",
      "A server running multiple copies of an LLM",
      "An agent using multiple API keys",
  ...
  {
    "question": "Which Python feature is used to build a generator function? (Practice)",
    "options": [
      "The yield keyword",
      "The lambda operator",
      "Class definitions",
  ...
  {
    "question": "Concept check: Which Python feature is used to build a generator function?",
    "options": [
      "The yield keyword",
      "The lambda operator",
      "Class definitions",
  ...
  {
    "question": "Explain a decorator in Python? (Practice)",
    "options": [
      "A function that modifies the behavior of another function",
      "A GUI design tool",
      "A comment block detailing code structure",
  ...
  {
    "question": "Concept check: What is a decorator in Python?",
    "options": [
      "A function that modifies the behavior of another function",
      "A GUI design tool",
      "A comment block detailing code structure",
  ...
  {
    "question": "Which NumPy feature allows arithmetic operations on arrays of different shapes? (Practice)",
    "options": [
      "Broadcasting",
      "Slicing",
      "Vectorization",
  ...
  {
    "question": "Concept check: Which NumPy feature allows arithmetic operations on arrays of different shapes?",
    "options": [
      "Broadcasting",
      "Slicing",
      "Vectorization",
  ...
  {
    "question": "What does the double asterisk (**) operator represent in Python? (Practice)",
    "options": [
      "Exponentiation",
      "Multiplication",
      "Pointer dereferencing",
  ...
  {
    "question": "Concept check: What does the double asterisk (**) operator represent in Python?",
    "options": [
      "Exponentiation",
      "Multiplication",
      "Pointer dereferencing",
  ...
  {
    "question": "Which Python module is used to write asynchronous concurrent code? (Practice)",
    "options": [
      "asyncio",
      "threading",
      "multiprocessing",
  ...
  {
    "question": "Concept check: Which Python module is used to write asynchronous concurrent code?",
    "options": [
      "asyncio",
      "threading",
      "multiprocessing",
  ...
  {
    "question": "Explain the dot product of orthogonal vectors? (Practice)",
    "options": [
      "Zero",
      "One",
      "The product of their magnitudes",
  ...
  {
    "question": "Concept check: What is the dot product of orthogonal vectors?",
    "options": [
      "Zero",
      "One",
      "The product of their magnitudes",
  ...
  {
    "question": "What does the gradient of a multivariable function represent? (Practice)",
    "options": [
      "The direction of steepest ascent",
      "The local minimum coordinate",
      "The rate of change along the X-axis",
  ...
  {
    "question": "Concept check: What does the gradient of a multivariable function represent?",
    "options": [
      "The direction of steepest ascent",
      "The local minimum coordinate",
      "The rate of change along the X-axis",
  ...
  {
    "question": "Which rule is fundamental to computing gradients in backpropagation? (Practice)",
    "options": [
      "Chain Rule",
      "Product Rule",
      "L'Hopital's Rule",
  ...
  {
    "question": "Concept check: Which rule is fundamental to computing gradients in backpropagation?",
    "options": [
      "Chain Rule",
      "Product Rule",
      "L'Hopital's Rule",
  ...
  {
    "question": "What are the scalar values lambda associated with a matrix transformation Av = lambda v? (Practice)",
    "options": [
      "Eigenvalues",
      "Determinants",
      "Singular Values",
  ...
  {
    "question": "Concept check: What are the scalar values lambda associated with a matrix transformation Av = lambda v?",
    "options": [
      "Eigenvalues",
      "Determinants",
      "Singular Values",
  ...
  {
    "question": "What norm is defined as the sum of absolute values of vector elements? (Practice)",
    "options": [
      "L1 Norm",
      "L2 Norm",
      "Infinity Norm",
  ...
  {
    "question": "Concept check: What norm is defined as the sum of absolute values of vector elements?",
    "options": [
      "L1 Norm",
      "L2 Norm",
      "Infinity Norm",
  ...
  {
    "question": "What does a p-value represent in hypothesis testing? (Practice)",
    "options": [
      "Probability of observing test results under the null hypothesis",
      "Probability that the null hypothesis is true",
      "The significance level threshold",
  ...
  {
    "question": "Concept check: What does a p-value represent in hypothesis testing?",
    "options": [
      "Probability of observing test results under the null hypothesis",
      "Probability that the null hypothesis is true",
      "The significance level threshold",
  ...
  {
    "question": "Which theorem describes updating probability estimates based on new evidence? (Practice)",
    "options": [
      "Bayes Theorem",
      "Central Limit Theorem",
      "Law of Large Numbers",
  ...
  {
    "question": "Concept check: Which theorem describes updating probability estimates based on new evidence?",
    "options": [
      "Bayes Theorem",
      "Central Limit Theorem",
      "Law of Large Numbers",
  ...
  {
    "question": "What does the Central Limit Theorem state about sample means? (Practice)",
    "options": [
      "Sample means will follow normal distribution as sample size grows",
      "Sample variance equals population variance",
      "The mean of any sample is exactly zero",
  ...
  {
    "question": "Concept check: What does the Central Limit Theorem state about sample means?",
    "options": [
      "Sample means will follow normal distribution as sample size grows",
      "Sample variance equals population variance",
      "The mean of any sample is exactly zero",
  ...
  {
    "question": "Explain a Type I error in statistics? (Practice)",
    "options": [
      "Rejecting a true null hypothesis (false positive)",
      "Failing to reject a false null hypothesis",
      "Measuring standard deviation incorrectly",
  ...
  {
    "question": "Concept check: What is a Type I error in statistics?",
    "options": [
      "Rejecting a true null hypothesis (false positive)",
      "Failing to reject a false null hypothesis",
      "Measuring standard deviation incorrectly",
  ...
  {
    "question": "What statistical method measures the relationship between a dependent and independent variable? (Practice)",
    "options": [
      "Regression analysis",
      "Hypothesis testing",
      "Principal component analysis",
  ...
  {
    "question": "Concept check: What statistical method measures the relationship between a dependent and independent variable?",
    "options": [
      "Regression analysis",
      "Hypothesis testing",
      "Principal component analysis",
  ...
  {
    "question": "Explain the time complexity of searching in a sorted array using Binary Search? (Practice)",
    "options": [
      "O(log n)",
      "O(n)",
      "O(n log n)",
  ...
  {
    "question": "Concept check: What is the time complexity of searching in a sorted array using Binary Search?",
    "options": [
      "O(log n)",
      "O(n)",
      "O(n log n)",
  ...
  {
    "question": "Which data structure operates on a First-In-First-Out (FIFO) basis? (Practice)",
    "options": [
      "Queue",
      "Stack",
      "Binary Tree",
  ...
  {
    "question": "Concept check: Which data structure operates on a First-In-First-Out (FIFO) basis?",
    "options": [
      "Queue",
      "Stack",
      "Binary Tree",
  ...
  {
    "question": "Which algorithm is used to find the shortest path in a weighted graph with positive weights? (Practice)",
    "options": [
      "Dijkstra's Algorithm",
      "Kruskal's Algorithm",
      "Bellman-Ford Algorithm",
  ...
  {
    "question": "Concept check: Which algorithm is used to find the shortest path in a weighted graph with positive weights?",
    "options": [
      "Dijkstra's Algorithm",
      "Kruskal's Algorithm",
      "Bellman-Ford Algorithm",
  ...
  {
    "question": "Explain the core difference between memoization and tabulation in dynamic programming? (Practice)",
    "options": [
      "Memoization is top-down (caching); Tabulation is bottom-up (table filling)",
      "Memoization is slower; Tabulation uses recursion",
      "Memoization uses trees; Tabulation uses stacks",
  ...
  {
    "question": "Concept check: What is the core difference between memoization and tabulation in dynamic programming?",
    "options": [
      "Memoization is top-down (caching); Tabulation is bottom-up (table filling)",
      "Memoization is slower; Tabulation uses recursion",
      "Memoization uses trees; Tabulation uses stacks",
  ...
  {
    "question": "Explain the average time complexity of insertion in a Hash Table? (Practice)",
    "options": [
      "O(1)",
      "O(n)",
      "O(log n)",
  ...
  {
    "question": "Concept check: What is the average time complexity of insertion in a Hash Table?",
    "options": [
      "O(1)",
      "O(n)",
      "O(log n)",
  ...
  {
    "question": "Explain the purpose of experiment tracking tools like MLflow? (Practice)",
    "options": [
      "To log model parameters, metrics, and artifacts during training",
      "To scale computing cluster sizes automatically",
      "To perform feature engineering on datasets",
  ...
  {
    "question": "Concept check: What is the purpose of experiment tracking tools like MLflow?",
    "options": [
      "To log model parameters, metrics, and artifacts during training",
      "To scale computing cluster sizes automatically",
      "To perform feature engineering on datasets",
  ...
  {
    "question": "Explain 'data drift' in production ML systems? (Practice)",
    "options": [
      "A change in input data distribution over time",
      "Loss of database connection",
      "Duplicate records in the training set",
  ...
  {
    "question": "Concept check: What is 'data drift' in production ML systems?",
    "options": [
      "A change in input data distribution over time",
      "Loss of database connection",
      "Duplicate records in the training set",
  ...
  {
    "question": "Which tool is standard for versioning datasets in ML projects? (Practice)",
    "options": [
      "DVC (Data Version Control)",
      "Git",
      "Docker",
  ...
  {
    "question": "Concept check: Which tool is standard for versioning datasets in ML projects?",
    "options": [
      "DVC (Data Version Control)",
      "Git",
      "Docker",
  ...
  {
    "question": "What does a Model Registry do in MLOps? (Practice)",
    "options": [
      "Stores, versions, and manages the lifecycle of trained models",
      "Downloads datasets automatically from Kaggle",
      "Compresses model weights to reduce disk space",
  ...
  {
    "question": "Concept check: What does a Model Registry do in MLOps?",
    "options": [
      "Stores, versions, and manages the lifecycle of trained models",
      "Downloads datasets automatically from Kaggle",
      "Compresses model weights to reduce disk space",
  ...
  {
    "question": "What deployment strategy involves routeing a small fraction of traffic to the new model? (Practice)",
    "options": [
      "Canary Deployment",
      "Blue-Green Deployment",
      "Re-create Deployment",
  ...
  {
    "question": "Concept check: What deployment strategy involves routeing a small fraction of traffic to the new model?",
    "options": [
      "Canary Deployment",
      "Blue-Green Deployment",
      "Re-create Deployment",
  ...
  {
    "question": "Which AWS service is a fully-managed platform to build, train, and deploy ML models? (Practice)",
    "options": [
      "Amazon SageMaker",
      "Amazon EC2",
      "Amazon S3",
  ...
  {
    "question": "Concept check: Which AWS service is a fully-managed platform to build, train, and deploy ML models?",
    "options": [
      "Amazon SageMaker",
      "Amazon EC2",
      "Amazon S3",
  ...
  {
    "question": "Explain the Google Cloud equivalent of AWS SageMaker for end-to-end ML? (Practice)",
    "options": [
      "Vertex AI",
      "Google App Engine",
      "Compute Engine",
  ...
  {
    "question": "Concept check: What is the Google Cloud equivalent of AWS SageMaker for end-to-end ML?",
    "options": [
      "Vertex AI",
      "Google App Engine",
      "Compute Engine",
  ...
  {
    "question": "Why are Cloud Spot Instances frequently used in training deep learning models? (Practice)",
    "options": [
      "They offer up to 90% cost savings compared to on-demand instances",
      "They have higher GPU memory limits",
      "They cannot be interrupted during training",
  ...
  {
    "question": "Concept check: Why are Cloud Spot Instances frequently used in training deep learning models?",
    "options": [
      "They offer up to 90% cost savings compared to on-demand instances",
      "They have higher GPU memory limits",
      "They cannot be interrupted during training",
  ...
  {
    "question": "What cloud service is typically used to store large raw datasets? (Practice)",
    "options": [
      "Object Storage (like Amazon S3)",
      "Relational Database (like AWS RDS)",
      "In-memory cache (like Redis)",
  ...
  {
    "question": "Concept check: What cloud service is typically used to store large raw datasets?",
    "options": [
      "Object Storage (like Amazon S3)",
      "Relational Database (like AWS RDS)",
      "In-memory cache (like Redis)",
  ...
  {
    "question": "Explain serverless AI inference? (Practice)",
    "options": [
      "Running model predictions on request without managing persistent servers",
      "Running models locally on the user's laptop",
      "Training models without cloud compute units",
  ...
  {
    "question": "Concept check: What is serverless AI inference?",
    "options": [
      "Running model predictions on request without managing persistent servers",
      "Running models locally on the user's laptop",
      "Training models without cloud compute units",
  ...
  {
    "question": "Explain the role of virtual DOM reconciliation in React? (Practice)",
    "options": [
      "Comparing virtual DOM with real DOM and updating changed elements only",
      "Structuring HTML templates in files",
      "Saving component states to local storage",
  ...
  {
    "question": "Concept check: What is the role of virtual DOM reconciliation in React?",
    "options": [
      "Comparing virtual DOM with real DOM and updating changed elements only",
      "Structuring HTML templates in files",
      "Saving component states to local storage",
  ...
  {
    "question": "Which React hook is used to cache calculations between component re-renders? (Practice)",
    "options": [
      "useMemo",
      "useCallback",
      "useEffect",
  ...
  {
    "question": "Concept check: Which React hook is used to cache calculations between component re-renders?",
    "options": [
      "useMemo",
      "useCallback",
      "useEffect",
  ...
  {
    "question": "Explain the primary difference between Client-Side Rendering (CSR) and Server-Side Rendering (SSR)? (Practice)",
    "options": [
      "SSR sends pre-rendered HTML to the browser; CSR sends minimal HTML and JS",
      "CSR is faster on initial page load",
      "SSR requires more client-side processing",
  ...
  {
    "question": "Concept check: What is the primary difference between Client-Side Rendering (CSR) and Server-Side Rendering (SSR)?",
    "options": [
      "SSR sends pre-rendered HTML to the browser; CSR sends minimal HTML and JS",
      "CSR is faster on initial page load",
      "SSR requires more client-side processing",
  ...
  {
    "question": "Which CSS layout model is designed for 1-dimensional layouts (row or column)? (Practice)",
    "options": [
      "Flexbox",
      "CSS Grid",
      "Absolute positioning",
  ...
  {
    "question": "Concept check: Which CSS layout model is designed for 1-dimensional layouts (row or column)?",
    "options": [
      "Flexbox",
      "CSS Grid",
      "Absolute positioning",
  ...
  {
    "question": "In TypeScript, what is a generic type used for? (Practice)",
    "options": [
      "Creating reusable components that work with a variety of types",
      "Declaring local variables inside functions",
      "Exporting classes to other files",
  ...
  {
    "question": "Concept check: In TypeScript, what is a generic type used for?",
    "options": [
      "Creating reusable components that work with a variety of types",
      "Declaring local variables inside functions",
      "Exporting classes to other files",
  ...
  {
    "question": "Which HTTP status code represents an authentication credentials failure? (Practice)",
    "options": [
      "401 Unauthorized",
      "403 Forbidden",
      "404 Not Found",
  ...
  {
    "question": "Concept check: Which HTTP status code represents an authentication credentials failure?",
    "options": [
      "401 Unauthorized",
      "403 Forbidden",
      "404 Not Found",
  ...
  {
    "question": "What problem occurs when a query fetches parent records and triggers separate queries for each child? (Practice)",
    "options": [
      "N+1 Query Problem",
      "Memory leak",
      "Circular reference",
  ...
  {
    "question": "Concept check: What problem occurs when a query fetches parent records and triggers separate queries for each child?",
    "options": [
      "N+1 Query Problem",
      "Memory leak",
      "Circular reference",
  ...
  {
    "question": "Where is a JWT (JSON Web Token) signature verified? (Practice)",
    "options": [
      "On the server using a secret key",
      "In the client-side browser",
      "In a public blockchain",
  ...
  {
    "question": "Concept check: Where is a JWT (JSON Web Token) signature verified?",
    "options": [
      "On the server using a secret key",
      "In the client-side browser",
      "In a public blockchain",
  ...
  {
    "question": "What does database indexing improve? (Practice)",
    "options": [
      "Query read performance",
      "Data insertion write speeds",
      "Database storage volume sizes",
  ...
  {
    "question": "Concept check: What does database indexing improve?",
    "options": [
      "Query read performance",
      "Data insertion write speeds",
      "Database storage volume sizes",
  ...
  {
    "question": "Which framework is a popular high-performance Python choice for building APIs? (Practice)",
    "options": [
      "FastAPI",
      "Express.js",
      "Django Templates",
  ...
  {
    "question": "Concept check: Which framework is a popular high-performance Python choice for building APIs?",
    "options": [
      "FastAPI",
      "Express.js",
      "Django Templates",
  ...
  {
    "question": "Explain the purpose of Git rebase compared to Git merge? (Practice)",
    "options": [
      "To integrate changes from one branch into another with a clean linear history",
      "To push commits to the remote repository",
      "To delete local file histories",
  ...
  {
    "question": "Concept check: What is the purpose of Git rebase compared to Git merge?",
    "options": [
      "To integrate changes from one branch into another with a clean linear history",
      "To push commits to the remote repository",
      "To delete local file histories",
  ...
  {
    "question": "Which command saves uncommitted local edits temporarily without committing them? (Practice)",
    "options": [
      "git stash",
      "git checkout",
      "git reset",
  ...
  {
    "question": "Concept check: Which command saves uncommitted local edits temporarily without committing them?",
    "options": [
      "git stash",
      "git checkout",
      "git reset",
  ...
  {
    "question": "How are merge conflicts resolved in Git? (Practice)",
    "options": [
      "By manually editing conflicting lines and committing the result",
      "By force pushing changes immediately",
      "By running git delete-conflict",
  ...
  {
    "question": "Concept check: How are merge conflicts resolved in Git?",
    "options": [
      "By manually editing conflicting lines and committing the result",
      "By force pushing changes immediately",
      "By running git delete-conflict",
  ...
  {
    "question": "What does a pull request (PR) facilitate? (Practice)",
    "options": [
      "Code review and discussion before merging changes into a branch",
      "Downloading external package dependencies",
      "Configuring CI/CD servers",
  ...
  {
    "question": "Concept check: What does a pull request (PR) facilitate?",
    "options": [
      "Code review and discussion before merging changes into a branch",
      "Downloading external package dependencies",
      "Configuring CI/CD servers",
  ...
  {
    "question": "Explain the purpose of a .gitignore file? (Practice)",
    "options": [
      "To specify files Git should track and index",
      "To store repository credentials securely",
      "To configure the default editor",
  ...
  {
    "question": "Concept check: What is the purpose of a .gitignore file?",
    "options": [
      "To specify files Git should track and index",
      "To store repository credentials securely",
      "To configure the default editor",
...
export async function seed() {
  try {
    console.log('🌱 Starting automatic seed of large dataset...');
    ...
    const domainMap = {};
    createdDomains.forEach(d => { domainMap[d.name] = d; });
